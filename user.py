...
Enter the option: 
    1. CREATE TABLE
    2. DUMP users from csv INFO users TABLE 
...
def main(): # main aba funcction yaha bata suru bhayo, number magxa ani tehi anusar input_string run garxa
